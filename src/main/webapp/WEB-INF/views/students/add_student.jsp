	...
	<div id="layoutSidenav">
		...
		<div id="layoutSidenav_content">
			...
			<div class="container-fluid px-4">
				...
				<a href="/projectAPI_war/admin/students/add" class="btn btn-primary">Add
					Student</a>
				<div class="card mb-4">
					<div class="card-body">
				...
				<div class="card mb-4">
					...
					<div class="card-body">
						<form:form modelAttribute="studentDTO"
							action="/projectAPI_war/admin/students/add_action" method="post">
							<table>
								<tr>
									<td>ID:</td>
								...
								<tr>
									<td>Class:</td>
									<td><select name='classId' class="form-select"
								...
								<tr>
									<td>Avatar:</td>
									<td><form:input path="picture" class="form-control" /></td>
								</tr>
								<tr>
									<td>Phone Number:</td>
